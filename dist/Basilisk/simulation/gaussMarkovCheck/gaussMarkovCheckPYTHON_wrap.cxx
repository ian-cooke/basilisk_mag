...
#define SWIGTYPE_p_Eigen__Vector2d swig_types[1]
#define SWIGTYPE_p_char swig_types[2]
#define SWIGTYPE_p_double swig_types[3]
#define SWIGTYPE_p_f___int swig_types[4]
...
/*-----------------------------------------------
              @(target):= _gaussMarkovCheck.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__gaussMarkovCheck

#else
#  define SWIG_init    init_gaussMarkovCheck

#endif
#define SWIG_name    "_gaussMarkovCheck"
...
SWIGINTERN PyObject *_wrap_testGaussMarkov(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)":testGaussMarkov")) SWIG_fail;
  result = (int)testGaussMarkov();
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_calculateSD(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Eigen::MatrixXd arg1 ;
  uint64_t arg2 ;
  void *argp1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:calculateSD",&obj0,&obj1)) SWIG_fail;
  {
    res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_Eigen__MatrixXd,  0  | 0);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "calculateSD" "', argument " "1"" of type '" "Eigen::MatrixXd""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "calculateSD" "', argument " "1"" of type '" "Eigen::MatrixXd""'");
    } else {
      Eigen::MatrixXd * temp = reinterpret_cast< Eigen::MatrixXd * >(argp1);
      arg1 = *temp;
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "calculateSD" "', argument " "2"" of type '" "uint64_t""'");
  } 
  arg2 = static_cast< uint64_t >(val2);
  result = calculateSD(arg1,arg2);
  resultobj = SWIG_NewPointerObj((new Eigen::Vector2d(static_cast< const Eigen::Vector2d& >(result))), SWIGTYPE_p_Eigen__Vector2d, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"testGaussMarkov", _wrap_testGaussMarkov, METH_VARARGS, (char *)"swig_ptr: testGaussMarkov_cb_ptr"},
	 { (char *)"calculateSD", _wrap_calculateSD, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_Eigen__Vector2d = {"_p_Eigen__Vector2d", "Eigen::Vector2d *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_Eigen__Vector2d[] = {  {&_swigt__p_Eigen__Vector2d, 0, 0, 0},{0, 0, 0, 0}};
...
{ SWIG_PY_POINTER, (char*)"testGaussMarkov_cb_ptr", 0, 0, (void *)((int (*)())(testGaussMarkov)), &SWIGTYPE_p_f___int },
{0, 0, 0, 0.0, 0, 0}};
