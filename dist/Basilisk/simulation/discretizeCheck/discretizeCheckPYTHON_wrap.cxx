...
/*-----------------------------------------------
              @(target):= _discretizeCheck.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__discretizeCheck

#else
#  define SWIG_init    init_discretizeCheck

#endif
#define SWIG_name    "_discretizeCheck"
...
SWIGINTERN PyObject *_wrap_testDiscretize(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)":testDiscretize")) SWIG_fail;
  result = (int)testDiscretize();
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"testDiscretize", _wrap_testDiscretize, METH_VARARGS, (char *)"swig_ptr: testDiscretize_cb_ptr"},
	 { NULL, NULL, 0, NULL }
};
...
{ SWIG_PY_POINTER, (char*)"testDiscretize_cb_ptr", 0, 0, (void *)((int (*)())(testDiscretize)), &SWIGTYPE_p_f___int },
{0, 0, 0, 0.0, 0, 0}};
