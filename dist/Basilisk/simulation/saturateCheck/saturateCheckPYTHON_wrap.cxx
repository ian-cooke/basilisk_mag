...
/*-----------------------------------------------
              @(target):= _saturateCheck.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__saturateCheck

#else
#  define SWIG_init    init_saturateCheck

#endif
#define SWIG_name    "_saturateCheck"
...
SWIGINTERN PyObject *_wrap_testSaturate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!PyArg_ParseTuple(args,(char *)":testSaturate")) SWIG_fail;
  result = (int)testSaturate();
  resultobj = SWIG_From_int(static_cast< int >(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"testSaturate", _wrap_testSaturate, METH_VARARGS, (char *)"swig_ptr: testSaturate_cb_ptr"},
	 { NULL, NULL, 0, NULL }
};
...
{ SWIG_PY_POINTER, (char*)"testSaturate_cb_ptr", 0, 0, (void *)((int (*)())(testSaturate)), &SWIGTYPE_p_f___int },
{0, 0, 0, 0.0, 0, 0}};
